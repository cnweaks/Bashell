 ...
 */
package com.cnweak.rebash.data;
...
public class BashDataBase {

	protected static final String TAG = BashDataBase.class.getSimpleName();	
	...
	protected static final BashDataBase mInstance = new BashDataBase();
	...
	private BashDataBase() {};

	public static BashDataBase getInstance() {
	    return mInstance;
	}
