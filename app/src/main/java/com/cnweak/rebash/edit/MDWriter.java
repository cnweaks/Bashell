...
public class MDWriter {
    ...
    public boolean InputText(String text) {
        String content = mEditText.getText().toString();//内容
        Position position = getCurrentLinePosition(content);//指针
		insert(position.end+1,text);
		return true;
    }
    /**
    ...
    public void Inputtouch(MotionEvent touch){
        Instrumentation inst=new Instrumentation();
        inst.sendPointerSync(touch);
    }
